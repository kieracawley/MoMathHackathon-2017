...
(function(process) {
  var o3dgc = (function() {
    ...
    local.O3DGC_BINARY_STREAM_MAX_SYMBOL0 = 127;
    local.O3DGC_BINARY_STREAM_BITS_PER_SYMBOL1 = 6;
    local.O3DGC_BINARY_STREAM_MAX_SYMBOL1 = 63;
    local.O3DGC_BINARY_STREAM_NUM_SYMBOLS_UINT32 = 5;
    ...
    local.O3DGC_SC3DMC_BINARIZATION_FL = 0;
    local.O3DGC_SC3DMC_BINARIZATION_BP = 1;
    local.O3DGC_SC3DMC_BINARIZATION_FC = 2;
    local.O3DGC_SC3DMC_BINARIZATION_AC = 3;
    local.O3DGC_SC3DMC_BINARIZATION_AC_EGC = 4;
    local.O3DGC_SC3DMC_BINARIZATION_ASCII = 5;
    local.O3DGC_STREAM_TYPE_UNKOWN = 0;
    local.O3DGC_STREAM_TYPE_ASCII = 1;
    local.O3DGC_STREAM_TYPE_BINARY = 2;
    local.O3DGC_SC3DMC_NO_PREDICTION = 0;
    local.O3DGC_SC3DMC_DIFFERENTIAL_PREDICTION = 1;
    local.O3DGC_SC3DMC_XOR_PREDICTION = 2;
    local.O3DGC_SC3DMC_ADAPTIVE_DIFFERENTIAL_PREDICTION = 3;
    local.O3DGC_SC3DMC_CIRCULAR_DIFFERENTIAL_PREDICTION = 4;
    local.O3DGC_SC3DMC_PARALLELOGRAM_PREDICTION = 5;
    local.O3DGC_SC3DMC_SURF_NORMALS_PREDICTION = 6;
    local.O3DGC_SC3DMC_ENCODE_MODE_QBCR = 0;
    local.O3DGC_SC3DMC_ENCODE_MODE_SVA = 1;
    local.O3DGC_SC3DMC_ENCODE_MODE_TFAN = 2;
    ...
    local.O3DGC_AC_MIN_LENGTH = 0x01000000;
    local.O3DGC_AC_MAX_LENGTH = 0xFFFFFFFF;
    local.O3DGC_AC_BM_LENGTH_SHIFT = 13;
    local.O3DGC_AC_BM_MAX_COUNT = (1 << local.O3DGC_AC_BM_LENGTH_SHIFT) >>> 0;
    local.O3DGC_AC_DM_LENGTH_SHIFT = 15;
    local.O3DGC_AC_DM_MAX_COUNT = (1 << local.O3DGC_AC_DM_LENGTH_SHIFT) >>> 0;
    ...
    module.AdaptiveDataModel.prototype.SetAlphabet = function(number_of_symbols) {
      ...
      if (this.m_dataSymbols !== number_of_symbols) {
    ...
    module.ArithmeticDecoder.prototype.GetBit = function() {
      this.m_length >>>= 1;
      var bit = (this.m_value >= this.m_length);
      if (bit) {
        this.m_value -= this.m_length;
      }
      if (this.m_length < local.O3DGC_AC_MIN_LENGTH) {
        this.RenormDecInterval();
      }
      return bit;
    };
    module.ArithmeticDecoder.prototype.GetBits = function(bits) {
      var s = Math.floor(this.m_value / (this.m_length >>>= bits));
      this.m_value -= this.m_length * s;
      if (this.m_length < local.O3DGC_AC_MIN_LENGTH) {
        this.RenormDecInterval();
      }
      return s;
    ...
    module.ArithmeticDecoder.prototype.DecodeStaticBitModel = function(M) {
      var x,
          bit;
      x = M.m_bit0Prob * (this.m_length >>> local.O3DGC_AC_BM_LENGTH_SHIFT);
      bit = (this.m_value >= x);
      if (!bit) {
        this.m_length = x;
      } else {
    ...
    module.ArithmeticDecoder.prototype.RenormDecInterval = function() {
      ...
      } while (this.m_length < local.O3DGC_AC_MIN_LENGTH);
    };
    ...
    module.AdjacencyInfo = function() {
      this.m_neighborsSize = 0;
      this.m_numNeighborsSize = 0;
    ...
    module.TriangleListDecoder = function() {
      ...
      this.m_processConfig = {
        ...
        1: function(decoder, degree, focusVertex) {
          var u,
              op,
              index;
          decoder.m_tfans.AddVertex(decoder.m_visitedVertices[0]);
        ...
        8: function(decoder, degree, focusVertex) {
          var u,
              op,
              index;
          decoder.m_tfans.AddVertex(decoder.m_visitedVertices[1]);
        ...
        9: function(decoder, degree, focusVertex) {
          var u,
              op,
              index;
          for (u = 0; u < degree; ++u) {
    ...
    module.SC3DMCDecoder.prototype.DecodeIntArrayBinary = function(intArray, numIntArray, dimIntArray, stride, ifs, predMode, bstream) {
      var testPredEnabled,
          bestPred,
          i,
          u,
    ...
    module.SC3DMCDecoder.prototype.DecodeIntArrayASCII = function(intArray, numIntArray, dimIntArray, stride, ifs, predMode, bstream) {
      var testPredEnabled,
          iterator,
          streamType,
          predResidual,
    ...
    module.SC3DMCDecoder.prototype.DecodeIntArray = function(intArray, numIntArray, dimIntArray, stride, ifs, predMode, bstream) {
    ...
    module.SC3DMCDecoder.prototype.IQuantize = function(floatArray, numFloatArray, dimFloatArray, stride, minFloatArray, maxFloatArray, nQBits, predMode) {
      var v,
          nin,
          nout,
          orientation,
    ...
    module.SC3DMCDecoder.prototype.DecodeFloatArrayBinary = function(floatArray, numFloatArray, dimFloatArray, stride, minFloatArray, maxFloatArray, nQBits, ifs, predMode, bstream) {
      var maxNPred,
          testPredEnabled,
          testParaPredEnabled,
          bestPred,
    ...
    module.SC3DMCDecoder.prototype.DecodeFloatArrayASCII = function(floatArray, numFloatArray, dimFloatArray, stride, minFloatArray, maxFloatArray, nQBits, ifs, predMode, bstream) {
      var maxNPred,
          testPredEnabled,
          testParaPredEnabled,
          iterator,
    ...
    module.SC3DMCDecoder.prototype.DecodeFloatArray = function(floatArray, numFloatArray, dimFloatArray, stride, minFloatArray, maxFloatArray, nQBits, ifs, predMode, bstream) {
      if (this.m_streamType === local.O3DGC_STREAM_TYPE_ASCII) {
    ...
    module.DynamicVectorDecoder.prototype.IQuantize = function(floatArray, numFloatArray, dimFloatArray, stride, minFloatArray, maxFloatArray, nQBits) {
      var quantVectors,
          r,
          idelta,
          size,
    ...
    module.DynamicVectorDecoder.prototype.DecodePlayload = function(dynamicVector, bstream) {
      ...
      this.IQuantize(dynamicVector.GetVectors(), num, dim, dynamicVector.GetStride(), dynamicVector.GetMinArray(), dynamicVector.GetMaxArray(), this.m_params.GetQuantBits());
      return ret;
    };
    return module;
  })();

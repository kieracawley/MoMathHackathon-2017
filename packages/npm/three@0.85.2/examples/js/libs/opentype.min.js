 ...
 while (r >= 0);
      ...
      5: [function(require, module, exports) {
        ...
        Font.prototype.hasChar = function(e) {
          ...
          for (var s = void 0 === r.kerning ? !0 : r.kerning,
          ...
          if (util.isBrowser())
            window.requestFileSystem = window.requestFileSystem || window.webkitRequestFileSystem, window.requestFileSystem(window.TEMPORARY, i.byteLength, function(e) {
      ...
      6: [function(require, module, exports) {
        ...
        Glyph.prototype.bindConstructorValues = function(t) {
          ...
          for (var h = 1 / this.path.unitsPerEm * n,
              o = [],
              r = [],
              s = this.path,
      ...
      11: [function(require, module, exports) {
        ...
        Path.prototype.moveTo = function(t, o) {
          ...
          t = void 0 !== t ? t : 2;
          for (var i = "",
              s = 0; s < this.commands.length; s += 1) {
      ...
      12: [function(require, module, exports) {
        ...
        Substitution.prototype = Layout, Substitution.prototype.getGsubTable = function(t) {
          ...
          if (g >= 0) {
            for (var l = o.ligatureSets[g],
                c = 0; c < l.length; c++)
              if (arraysEqual(l[c].components, i))
                return;
            l.push(n);
          } else
            g = -1 - g, o.coverage.glyphs.splice(g, 0, u), o.ligatureSets.splice(g, 0, [n]);
      ...
      28: [function(require, module, exports) {
        ...
        function makeNameTable(e, a) {
          ...
          for (var c = reverseDict(macLanguages),

...
(function(Buffer) {
  ...
  THREE.DRACOLoader.prototype = {
    ...
    convertDracoGeometryTo3JS: function(wrapper, geometryType, buffer) {
      ...
      const posAttId = wrapper.GetAttributeId(dracoGeometry, dracoDecoder.POSITION);
      if (posAttId == -1) {
      ...
      const colorAttId = wrapper.GetAttributeId(dracoGeometry, dracoDecoder.COLOR);
      ...
      const normalAttId = wrapper.GetAttributeId(dracoGeometry, dracoDecoder.NORMAL);
      ...
      const texCoordAttId = wrapper.GetAttributeId(dracoGeometry, dracoDecoder.TEX_COORD);

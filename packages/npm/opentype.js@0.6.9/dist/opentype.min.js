    ...
    return (function e(t, n, r) {
      ...
      1: [function(require, module, exports) {
        ...
        function tinf_build_fixed_trees(e, t) {
          ...
          for (n = 0; n < 7; ++n)
            e.table[n] = 0;
          for (e.table[7] = 24, e.table[8] = 152, e.table[9] = 112, n = 0; n < 24; ++n)
            e.trans[n] = 256 + n;
          for (n = 0; n < 144; ++n)
            e.trans[24 + n] = n;
          for (n = 0; n < 8; ++n)
        ...
        function tinf_build_tree(e, t, n, r) {
          ...
          for (s = 0; s < r; ++s)
            e.table[t[n + s]]++;
          for (e.table[0] = 0, i = 0, s = 0; s < 16; ++s)
 ...
 while (r >= 0);
        ...
        function tinf_decode_trees(e, t, n) {
          var r,
              ...
              o,
              _;
          for (r = tinf_read_bits(e, 5, 257), s = tinf_read_bits(e, 5, 1), i = tinf_read_bits(e, 4, 4), a = 0; a < 19; ++a)
            lengths[a] = 0;
          for (a = 0; a < i; ++a) {
            var f = tinf_read_bits(e, 3, 0);
            lengths[clcidx[a]] = f;
          }
          for (tinf_build_tree(code_tree, lengths, 0, 19), o = 0; o < r + s; ) {
          ...
          for (; ; ) {
            ...
            if (r < 256)
              ...
              var s,
                  ...
                  a,
                  o;
              for (r -= 257, s = tinf_read_bits(e, length_bits[r], length_base[r]), i = tinf_decode_symbol(e, n), a = e.destLen - tinf_read_bits(e, dist_bits[i], dist_base[i]), o = a; o < a + s; ++o)
        ...
        function tinf_inflate_uncompressed_block(e) {
          ...
          if (t = e.source[e.sourceIndex + 1], t = 256 * t + e.source[e.sourceIndex], n = e.source[e.sourceIndex + 3], n = 256 * n + e.source[e.sourceIndex + 2], t !== (65535 & ~n))
      ...
      2: [function(require, module, exports) {
        "use strict";
        function derive(i, t, o, s, d) {
          return Math.pow(1 - d, 3) * i + 3 * Math.pow(1 - d, 2) * d * t + 3 * (1 - d) * Math.pow(d, 2) * o + Math.pow(d, 3) * s;
        }
        ...
        }, BoundingBox.prototype.addPoint = function(i, t) {
          "number" == typeof i && ((isNaN(this.x1) || isNaN(this.x2)) && (this.x1 = i, this.x2 = i), i < this.x1 && (this.x1 = i), i > this.x2 && (this.x2 = i)), "number" == typeof t && ((isNaN(this.y1) || isNaN(this.y2)) && (this.y1 = t, this.y2 = t), t < this.y1 && (this.y1 = t), t > this.y2 && (this.y2 = t));
        }, BoundingBox.prototype.addX = function(i) {
          this.addPoint(i, null);
        }, BoundingBox.prototype.addY = function(i) {
          this.addPoint(null, i);
        }, BoundingBox.prototype.addBezier = function(i, t, o, s, d, n, a, h) {
          var e = [i, t],
              r = [o, s],
              u = [d, n],
              N = [a, h];
          this.addPoint(i, t), this.addPoint(a, h);
          for (var x = 0; x <= 1; x++) {
            var p = 6 * e[x] - 12 * r[x] + 6 * u[x],
                y = -3 * e[x] + 9 * r[x] - 9 * u[x] + 3 * N[x],
                B = 3 * r[x] - 3 * e[x];
            if (0 !== y) {
              var v = Math.pow(p, 2) - 4 * B * y;
              if (!(v < 0)) {
                var f = (-p + Math.sqrt(v)) / (2 * y);
                0 < f && f < 1 && (0 === x && this.addX(derive(e[x], r[x], u[x], N[x], f)), 1 === x && this.addY(derive(e[x], r[x], u[x], N[x], f)));
                var c = (-p - Math.sqrt(v)) / (2 * y);
                0 < c && c < 1 && (0 === x && this.addX(derive(e[x], r[x], u[x], N[x], c)), 1 === x && this.addY(derive(e[x], r[x], u[x], N[x], c)));
              }
            } else {
              if (0 === p)
                continue;
              var g = -B / p;
              0 < g && g < 1 && (0 === x && this.addX(derive(e[x], r[x], u[x], N[x], g)), 1 === x && this.addY(derive(e[x], r[x], u[x], N[x], g)));
            }
          }
        }, BoundingBox.prototype.addQuad = function(i, t, o, s, d, n) {
          var a = i + 2 / 3 * (o - i),
              h = t + 2 / 3 * (s - t),
              e = a + 1 / 3 * (d - i),
              r = h + 1 / 3 * (n - t);
          this.addBezier(i, t, a, h, e, r, d, n);
          ...
          switch (e.version) {
            ...
            case 2:
              for (this.names = new Array(e.numberOfGlyphs), l = 0; l < e.numberOfGlyphs; l++)
                e.glyphNameIndex[l] < exports.standardNames.length ? this.names[l] = exports.standardNames[e.glyphNameIndex[l]] : this.names[l] = e.names[e.glyphNameIndex[l] - exports.standardNames.length];
              break;
            case 2.5:
              for (this.names = new Array(e.numberOfGlyphs), l = 0; l < e.numberOfGlyphs; l++)
      ...
      6: [function(require, module, exports) {
        ...
        function Font(e) {
          ...
          }, this.unitsPerEm = e.unitsPerEm || 1e3, this.ascender = e.ascender, this.descender = e.descender, this.createdTimestamp = e.createdTimestamp, this.tables = {os2: {
        ...
        Font.prototype.hasChar = function(e) {
        ...
        }, Font.prototype.stringToGlyphs = function(e, t) {
          t = t || this.defaultRenderOptions;
          var n,
              i = [];
          for (n = 0; n < e.length; n += 1) {
            var r = e[n];
            i.push(this.charToGlyphIndex(r));
          }
          var o = i.length;
          if (t.features) {
            var s = t.script || this.substitution.getDefaultScriptName(),
                a = [];
            for (t.features.liga && (a = a.concat(this.substitution.getFeature("liga", s, t.language))), t.features.rlig && (a = a.concat(this.substitution.getFeature("rlig", s, t.language))), n = 0; n < o; n += 1)
              for (var h = 0; h < a.length; h++) {
                for (var u = a[h],
                    ...
                    p = 0; p < c && l[p] === i[n + p]; )
                  p++;
                p === c && (i.splice(n, c, u.by), o = o - c + 1);
              }
          }
          var g = new Array(o),
              f = this.glyphs.get(0);
          for (n = 0; n < o; n += 1)
            g[n] = this.glyphs.get(i[n]) || f;
          return g;
          ...
          t = void 0 !== t ? t : 0, n = void 0 !== n ? n : 0, i = void 0 !== i ? i : 72, r = r || this.defaultRenderOptions;
          for (var s = 1 / this.unitsPerEm * i,
              a = this.stringToGlyphs(e, r),
              h = 0; h < a.length; h += 1) {
            var u = a[h];
            if (o(u, t, n, i, r), u.advanceWidth && (t += u.advanceWidth * s), r.kerning && h < a.length - 1) {
              var l = this.getKerningValue(u, a[h + 1]);
              t += l * s;
            }
            r.letterSpacing ? t += r.letterSpacing * i : r.tracking && (t += r.tracking / 1e3 * i);
          }
          ...
          for (var e = this.toTables(),
            ...
            i[r] = t[r];
          return n;
        }, Font.prototype.download = function(e) {
          var t = this.getEnglishName("fontFamily"),
              n = this.getEnglishName("fontSubfamily");
          e = e || t.replace(/\s/g, "") + "-" + n + ".otf";
          var i = this.toArrayBuffer();
          if (util.isBrowser())
            window.requestFileSystem = window.requestFileSystem || window.webkitRequestFileSystem, window.requestFileSystem(window.TEMPORARY, i.byteLength, function(t) {
      ...
      7: [function(require, module, exports) {
        ...
        Glyph.prototype.bindConstructorValues = function(t) {
          ...
          for (var a = 1 / this.path.unitsPerEm * e,
              o = n.xScale * a,
              h = n.yScale * a,
              r = new path.Path,
              ...
              p = 0; p < s.length; p += 1) {
            var y = s[p];
            "M" === y.type ? r.moveTo(t + y.x * o, i + -y.y * h) : "L" === y.type ? r.lineTo(t + y.x * o, i + -y.y * h) : "Q" === y.type ? r.quadraticCurveTo(t + y.x1 * o, i + -y.y1 * h, t + y.x * o, i + -y.y * h) : "C" === y.type ? r.curveTo(t + y.x1 * o, i + -y.y1 * h, t + y.x2 * o, i + -y.y2 * h, t + y.x * o, i + -y.y * h) : "Z" === y.type && r.closePath();
          }
          return r;
          ...
          function a(i, e, n, a) {
            ...
            for (var h = 0; h < i.length; h += 1)
              t.moveTo(e + i[h].x * a, n + i[h].y * a), t.arc(e + i[h].x * a, n + i[h].y * a, 2, 0, o, !1);
            t.closePath(), t.fill();
          }
          i = void 0 !== i ? i : 0, e = void 0 !== e ? e : 0, n = void 0 !== n ? n : 24;
          for (var o = 1 / this.path.unitsPerEm * n,
              h = [],
              r = [],
              s = this.path,
              p = 0; p < s.commands.length; p += 1) {
            var y = s.commands[p];
            void 0 !== y.x && h.push({
              x: y.x,
              y: -y.y
          ...
          t.fillStyle = "blue", a(h, i, e, o), t.fillStyle = "red", a(r, i, e, o);
          ...
          t.strokeStyle = "blue", draw.line(t, i + o * a, -1e4, i + o * a, 1e4), draw.line(t, i + r * a, -1e4, i + r * a, 1e4), draw.line(t, -1e4, e + -h * a, 1e4, e + -h * a), draw.line(t, -1e4, e + -s * a, 1e4, e + -s * a), t.strokeStyle = "green", draw.line(t, i + p * a, -1e4, i + p * a, 1e4);
        }, exports.Glyph = Glyph;
      }, {
        "./check": 3,
        "./draw": 4,
        ...
        Layout.prototype = {
          ...
          getScriptTable: function(e, t) {
            ...
            if (r) {
              ...
              if (t) {
                ...
                return a.splice(-1 - s, 0, n), n.script;
              }
            }
          },
          getLangSysTable: function(e, t, r) {
            ...
            if (a) {
              ...
              var s = searchTag(a.langSysRecords, t);
              if (s >= 0)
          ...
          getFeatureTable: function(e, t, r, a) {
            var s = this.getLangSysTable(e, t, a);
            if (s) {
              for (var n,
                  i = s.featureIndexes,
              ...
              if (a) {
                var f = u.length;
                return check.assert(0 === f || r >= u[f - 1].tag, "Features must be added in alphabetical order."), n = {
                  tag: r,
                  feature: {
                    params: 0,
                    lookupListIndexes: []
                  }
                }, u.push(n), i.push(f), n.feature;
              }
            }
          },
          getLookupTables: function(e, t, r, a, s) {
            var n = this.getFeatureTable(e, t, r, s),
                i = [];
            if (n) {
              for (var u,
                  l = n.lookupListIndexes,
                  f = this.font.tables[this.tableName].lookups,
                  o = 0; o < l.length; o++)
                u = f[l[o]], u.lookupType === a && i.push(u);
              if (0 === i.length && s) {
                u = {
                  lookupType: a,
                  lookupFlag: 0,
      ...
      10: [function(require, module, exports) {
        ...
        function parseBuffer(e) {
          ...
          if (t.tables.name = _name.parse(q.data, q.offset, r), t.names = t.tables.name, i && g) {
            var x = 0 === a,
                k = uncompressTable(n, g),
                w = loca.parse(k.data, k.offset, t.numGlyphs, x),
                O = uncompressTable(n, i);
            t.glyphs = glyf.parse(O.data, O.offset, w, t);
          } else {
            if (!f)
          ...
          if (hmtx.parse(L.data, L.offset, t.numberOfHMetrics, t.numGlyphs, t.glyphs), encoding.addGlyphNames(t), d) {
            var B = uncompressTable(n, d);
            t.kerningPairs = kern.parse(B.data, B.offset);
          } else
            t.kerningPairs = {};
          if (c) {
            var E = uncompressTable(n, c);
            gpos.parse(E.data, E.offset, t);
          }
          if (b) {
            var S = uncompressTable(n, b);
            t.tables.gsub = gsub.parse(S.data, S.offset);
          }
          if (u) {
            var G = uncompressTable(n, u);
            t.tables.fvar = fvar.parse(G.data, G.offset, t.names);
          }
          if (T) {
        ...
        exports._parse = parse, exports.Font = _font.Font, exports.Glyph = glyph.Glyph, exports.Path = path.Path, exports.BoundingBox = bbox.BoundingBox, exports.parse = parseBuffer, exports.load = load, exports.loadSync = loadSync;
      }, {
        "./bbox": 2,
        "./encoding": 5,
        "./font": 6,
      ...
      11: [function(require, module, exports) {
        ...
        Parser.prototype.parseByte = function() {
          ...
          if (r > 0)
            return new Parser(this.data, this.offset + r).parseStruct(t);
        }, Parser.prototype.parseListOfLists = function(t) {
          for (var r = this.parseOffset16List(),
              e = r.length,
            ...
            if (0 !== i)
              if (this.relativeOffset = i, t) {
                for (var n = this.parseOffset16List(),
        ...
        Parser.prototype.parseScriptList = function() {
          ...
          return this.parsePointer(Parser.list(Parser.pointer(function() {
            ...
            check.argument(1 <= r && r <= 8, "GSUB lookup type " + r + " unknown.");
      ...
      12: [function(require, module, exports) {
        ...
        Path.prototype.moveTo = function(t, o) {
        ...
        }, Path.prototype.curveTo = Path.prototype.bezierCurveTo = function(t, o, e, i, a, r) {
          this.commands.push({
            type: "C",
            x1: t,
            y1: o,
          ...
          if (t.commands)
            t = t.commands;
          else if (t instanceof bbox.BoundingBox) {
            var o = t;
            return this.moveTo(o.x1, o.y1), this.lineTo(o.x2, o.y1), this.lineTo(o.x2, o.y2), this.lineTo(o.x1, o.y2), void this.close();
          }
          Array.prototype.push.apply(this.commands, t);
        }, Path.prototype.getBoundingBox = function() {
          for (var t = new bbox.BoundingBox,
              o = 0,
              e = 0,
              i = 0,
              a = 0,
              r = 0; r < this.commands.length; r++) {
            var n = this.commands[r];
            switch (n.type) {
              case "M":
                t.addPoint(n.x, n.y), o = i = n.x, e = a = n.y;
                break;
              case "L":
                t.addPoint(n.x, n.y), i = n.x, a = n.y;
                break;
              case "Q":
                t.addQuad(i, a, n.x1, n.y1, n.x, n.y), i = n.x, a = n.y;
                break;
              case "C":
                t.addBezier(i, a, n.x1, n.y1, n.x2, n.y2, n.x, n.y), i = n.x, a = n.y;
                break;
              case "Z":
                i = o, a = e;
                break;
              default:
                throw new Error("Unexpected path commmand " + n.type);
            }
          }
          ...
          for (var i = "",
            ...
            var r = this.commands[a];
            "M" === r.type ? i += "M" + e(r.x, r.y) : "L" === r.type ? i += "L" + e(r.x, r.y) : "C" === r.type ? i += "C" + e(r.x1, r.y1, r.x2, r.y2, r.x, r.y) : "Q" === r.type ? i += "Q" + e(r.x1, r.y1, r.x, r.y) : "Z" === r.type && (i += "Z");
          }
          return i;
        ...
        }, Path.prototype.toDOMElement = function(t) {
          var o = this.toPathData(t),
              e = document.createElementNS("http://www.w3.org/2000/svg", "path");
          return e.setAttribute("d", o), e;
        }, exports.Path = Path;
      }, {"./bbox": 2}],
      13: [function(require, module, exports) {
        ...
        var check = require('./check'),
            ...
            Substitution = function(t) {
              Layout.call(this, t, "gsub");
            };
        Substitution.prototype = Layout.prototype, Substitution.prototype.createDefaultTable = function() {
          return {
            version: 1,
            scripts: [{
              tag: "DFLT",
          ...
          for (var a = [],
              s = this.getLookupTables(e, r, t, 1),
              o = 0; o < s.length; o++)
            for (var u = s[o].subtables,
                i = 0; i < u.length; i++) {
              var n,
                  l = u[i],
                  g = this.expandCoverage(l.coverage);
              if (1 === l.substFormat) {
          ...
          for (var a = [],
              s = this.getLookupTables(e, r, t, 3),
              o = 0; o < s.length; o++)
            for (var u = s[o].subtables,
                i = 0; i < u.length; i++)
              for (var n = u[i],
                  l = this.expandCoverage(n.coverage),
                  g = n.alternateSets,
                  c = 0; c < l.length; c++)
                a.push({
                  sub: l[c],
          ...
          for (var a = [],
              s = this.getLookupTables(e, r, t, 4),
              o = 0; o < s.length; o++)
            for (var u = s[o].subtables,
                i = 0; i < u.length; i++)
              for (var n = u[i],
                ...
                for (var b = l[c],
                  ...
                  var f = h[p];
                  a.push({
                    sub: [b].concat(f.components),
                    by: f.ligGlyph
                  });
                }
          return a;
        }, Substitution.prototype.addSingle = function(t, e, r, a) {
          var s = this.getLookupTables(r, a, t, 1, !0)[0],
          ...
          i < 0 && (i = -1 - i, o.coverage.glyphs.splice(i, 0, u), o.substitute.splice(i, 0, 0)), o.substitute[i] = e.by;
        }, Substitution.prototype.addAlternate = function(t, e, r, a) {
          var s = this.getLookupTables(r, a, t, 3, !0)[0],
          ...
          var u = e.sub,
              i = this.binSearch(o.coverage.glyphs, u);
          i < 0 && (i = -1 - i, o.coverage.glyphs.splice(i, 0, u), o.alternateSets.splice(i, 0, 0)), o.alternateSets[i] = e.by;
        }, Substitution.prototype.addLigature = function(t, e, r, a) {
          var s = this.getLookupTables(r, a, t, 4, !0)[0],
              o = s.subtables[0];
          o || (o = {
            substFormat: 1,
            coverage: {
          ...
          var u = e.sub[0],
              ...
              l = this.binSearch(o.coverage.glyphs, u);
          if (l >= 0) {
            for (var g = o.ligatureSets[l],
                c = 0; c < g.length; c++)
              if (arraysEqual(g[c].components, i))
                return;
            g.push(n);
          } else
            l = -1 - l, o.coverage.glyphs.splice(l, 0, u), o.ligatureSets.splice(l, 0, [n]);
      ...
      15: [function(require, module, exports) {
        ...
        function parseOperand(e, t) {
          ...
          if (29 === t)
            return a = e.parseByte(), r = e.parseByte(), n = e.parseByte(), s = e.parseByte(), a << 24 | r << 16 | n << 8 | s;
          if (30 === t)
            return parseFloatOperand(e);
          if (t >= 32 && t <= 246)
            return t - 139;
          if (t >= 247 && t <= 250)
        ...
        function parseCFFDict(e, t, a) {
          ...
          for (a = void 0 !== a ? a : e.length; r.relativeOffset < a; ) {
            var i = r.parseByte();
            i <= 21 ? (12 === i && (i = 1200 + r.parseByte()), n.push([i, s]), s = []) : s.push(parseOperand(r, i));
          }
          return entriesToObject(n);
        }
        function getCFFString(e, t) {
          return t = t <= 390 ? encoding.cffStandardStrings[t] : e[t - 391];
        }
        ...
        function parseCFFCharset(e, t, a, r) {
          ...
          if (0 === f)
            ...
            for (; h.length <= a; )
              for (s = o.parseSID(), i = o.parseCard8(), n = 0; n <= i; n += 1)
                h.push(getCFFString(r, s)), s += 1;
          else {
            if (2 !== f)
              throw new Error("Unknown charset format " + f);
            for (; h.length <= a; )
              for (s = o.parseSID(), i = o.parseCard16(), n = 0; n <= i; n += 1)
                h.push(getCFFString(r, s)), s += 1;
          }
          return h;
        }
        ...
        function parseCFFCharstring(e, t, a) {
          ...
          function n() {
            var t;
            t = u.length % 2 !== 0, t && !l && (d = u.shift() + e.nominalWidthX), c += u.length >> 1, u.length = 0, l = !0;
          }
          function s(a) {
            for (var y,
                b,
              ...
              switch (R += 1, M) {
                ...
                case 3:
                  ...
                  break;
                case 4:
                  u.length > 1 && !l && (d = u.shift() + e.nominalWidthX, l = !0), m += u.pop(), r(v, m);
                  break;
                case 5:
                  for (; u.length > 0; )
                ...
                case 12:
                  ...
                  break;
                case 14:
                  u.length > 0 && !l && (d = u.shift() + e.nominalWidthX, l = !0), g && (p.closePath(), g = !1);
                  break;
                case 18:
                  n();
                  break;
                ...
                case 20:
                  ...
                  break;
                case 21:
                  u.length > 2 && !l && (d = u.shift() + e.nominalWidthX, l = !0), m += u.pop(), v += u.pop(), r(v, m);
                  break;
                case 22:
                  u.length > 1 && !l && (d = u.shift() + e.nominalWidthX, l = !0), v += u.pop(), r(v, m);
                  break;
                case 23:
                  n();
                  break;
                ...
                case 31:
                  ...
                  break;
                default:
                  M < 32 ? console.log("Glyph " + t.index + ": unknown operator " + M) : M < 247 ? u.push(M - 139) : M < 251 ? (y = a[R], R += 1, u.push(256 * (M - 247) + y + 108)) : M < 255 ? (y = a[R], R += 1, u.push(256 * -(M - 251) - y - 108)) : (y = a[R], b = a[R + 1], C = a[R + 2], T = a[R + 3], R += 4, u.push((y << 24 | b << 16 | C << 8 | T) / 65536));
              }
            }
          }
          var i,
        ...
        function parseCFFTable(e, t, a) {
          ...
          if (a.defaultWidthX = u.defaultWidthX, a.nominalWidthX = u.nominalWidthX, 0 !== u.subrs) {
            var c = p + u.subrs,
                l = parseCFFIndex(e, c);
            a.subrs = l.objects, a.subrsBias = calcCFFSubroutineBias(a.subrs);
          } else
            a.subrs = [], a.subrsBias = 0;
          var d = parseCFFIndex(e, t + f.charStrings);
          a.nGlyphs = d.objects.length;
          var g = parseCFFCharset(e, t + f.charset, a.nGlyphs, i.objects);
          0 === f.encoding ? a.cffEncoding = new encoding.CffEncoding(encoding.cffStandardEncoding, g) : 1 === f.encoding ? a.cffEncoding = new encoding.CffEncoding(encoding.cffExpertEncoding, g) : a.cffEncoding = parseCFFEncoding(e, t + f.encoding, g), a.encoding = a.encoding || a.cffEncoding, a.glyphs = new glyphset.GlyphSet(a);
        ...
        function glyphToOps(e) {
          ...
          for (var r = 0,
            ...
            if ("M" === h.type)
              i = Math.round(h.x - r), o = Math.round(h.y - n), t.push({
                name: "dx",
                type: "NUMBER",
                value: i
              }), t.push({
      ...
      16: [function(require, module, exports) {
        ...
        function parseCmapTableFormat12(e, a) {
          ...
          var t;
          for (e.groupCount = t = a.parseULong(), e.glyphIndexMap = {}, r = 0; r < t; r += 1)
            for (var n = a.parseULong(),
                s = a.parseULong(),
                o = a.parseULong(),
                l = n; l <= s; l += 1)
      ...
      19: [function(require, module, exports) {
        ...
        function parseTaggedListTable(r, e) {
          for (var a = new parse.Parser(r, e),
              s = a.parseUShort(),
              t = [],
              o = 0; o < s; o++)
        ...
        function parseCoverageTable(r, e) {
          var a = new parse.Parser(r, e),
              ...
              t = a.parseUShort();
          if (1 === s)
            return a.parseUShortList(t);
          if (2 === s) {
            for (var o = []; t--; )
              for (var p = a.parseUShort(),
                  n = a.parseUShort(),
                  f = a.parseUShort(),
                  i = p; i <= n; i++)
                o[f++] = i;
        ...
        function parseLookupTable(r, e) {
          ...
          if (2 === s) {
            for (var i = [],
                h = 0; h < p; h++) {
              var S = parsePairPosSubTable(r, e + n[h]);
              S && i.push(S);
            }
      ...
      23: [function(require, module, exports) {
        ...
        function parseHmtxTable(e, a, r, t, s) {
          for (var i,
              l,
              n = new parse.Parser(e, a),
              p = 0; p < t; p += 1) {
            p < r && (i = n.parseUShort(), l = n.parseShort());
            var d = s.get(p);
            d.advanceWidth = i, d.leftSideBearing = l;
          }
        }
        function makeHmtxTable(e) {
          for (var a = new table.Table("hmtx", []),
              r = 0; r < e.length; r += 1) {
            var t = e.get(r),
                s = t.advanceWidth || 0,
      ...
      24: [function(require, module, exports) {
        "use strict";
        function parseWindowsKernTable(r) {
          var e = {};
          r.skip("uShort");
          var a = r.parseUShort();
          check.argument(0 === a, "Unsupported kern sub-table version."), r.skip("uShort", 2);
          var s = r.parseUShort();
          r.skip("uShort", 3);
          for (var t = 0; t < s; t += 1) {
            var o = r.parseUShort(),
        ...
        function parseMacKernTable(r) {
          var e = {};
          r.skip("uShort");
          var a = r.parseULong();
          a > 1 && console.warn("Only the first kern subtable is supported."), r.skip("uLong");
          var s = r.parseUShort(),
              t = 255 & s;
          if (r.skip("uShort"), 0 === t) {
            var o = r.parseUShort();
            r.skip("uShort", 3);
            for (var p = 0; p < o; p += 1) {
              var n = r.parseUShort(),
        ...
        function parseKernTable(r, e) {
          var a = new parse.Parser(r, e),
              s = a.parseUShort();
          if (0 === s)
            return parseWindowsKernTable(a);
          if (1 === s)
            return parseMacKernTable(a);
      ...
      25: [function(require, module, exports) {
        ...
        function parseLocaTable(r, a, e, s) {
          for (var p = new parse.Parser(r, a),
        ...
        function makeLtagTable(e) {
          for (var a = new table.Table("ltag", [{
            ...
            value: e.length
              ...
              n = 0; n < e.length; ++n) {
            var s = r.indexOf(e[n]);
            s < 0 && (s = r.length, r += e[n]), a.fields.push({
              name: "offset " + n,
              type: "USHORT",
              value: t + s
            }), a.fields.push({
      ...
      29: [function(require, module, exports) {
        ...
        function parseNameTable(e, a, r) {
          for (var n = {},
            ...
            if (void 0 !== v && void 0 !== h) {
              var x;
              if (x = v === utf16 ? decode.UTF16(e, c + p, f) : decode.MACSTRING(e, c + p, f, v)) {
                var y = n[d];
        ...
        function makeNameRecord(e, a, r, n, s, t) {
        ...
        function makeNameTable(e, a) {
          var r,
              n = [],
              s = {},
              t = reverseDict(nameTableNames);
          for (var m in e) {
            var c = t[m];
            if (void 0 === c && (c = m), r = parseInt(c), isNaN(r))
              throw new Error('Name table entry "' + m + '" does not exist, see nameTableNames for complete list.');
            s[r] = e[m], n.push(r);
          }
          for (var i = reverseDict(macLanguages),
            ...
            for (var f in d) {
              ...
              void 0 === b && (h = 0, v = a.indexOf(f), v < 0 && (v = a.length, a.push(f)), x = 4, b = encode.UTF16(p));
      ...
      32: [function(require, module, exports) {
        ...
        function makeSfntTable(e) {
          ...
          for (var t = [],
              r = [],
              i = a.sizeOf() + makeTableRecord().sizeOf() * a.numTables; i % 4 !== 0; )
            i += 1, r.push({
              name: "padding",
              type: "BYTE",
              value: 0
        ...
        function fontToSfntTable(e) {
          ...
          var b = head.make({
            ...
            createdTimestamp: e.createdTimestamp
              ...
              T = os2.make({
                ...
                ulCodePageRange1: 1,
                sxHeight: metricsForChar(e, "xyvw", {yMax: Math.round(x.ascender / 2)}).yMax,
          ...
          for (var q in e.names)
            W[q] = e.names[q];
          W.uniqueID || (W.uniqueID = {en: e.getEnglishName("manufacturer") + ":" + E}), W.postScriptName || (W.postScriptName = {en: O}), W.preferredFamily || (W.preferredFamily = e.names.fontFamily), W.preferredSubfamily || (W.preferredSubfamily = e.names.fontSubfamily);
          var w = [],
              B = _name.make(W, w),
      ...
      33: [function(require, module, exports) {
        ...
        encode.BYTE = function(e) {
          return check.argument(e >= 0 && e <= 255, "Byte value should be between 0 and 255."), [e];
          ...
          return e >= -107 && e <= 107 ? [e + 139] : e >= 108 && e <= 1131 ? (e -= 108, [(e >> 8) + 247, 255 & e]) : e >= -1131 && e <= -108 ? (e = -e - 108, [(e >> 8) + 251, 255 & e]) : e >= -32768 && e <= 32767 ? encode.NUMBER16(e) : encode.NUMBER32(e);
          ...
          if (t) {
            var c = parseFloat("1e" + ((t[2] ? +t[2] : 0) + t[1].length));
          ...
          for (o = 0, r = n.length; o < r; o += 1) {
            var i = n[o];
            a += "e" === i ? "-" === n[++o] ? "c" : "b" : "." === i ? "a" : "-" === i ? "e" : i;
          }
          a += 1 & a.length ? "f" : "ff";
          var f = [30];
          for (o = 0, r = a.length; o < r; o += 2)
            f.push(parseInt(a.substr(o, 2), 16));
          return f;
          ...
          for (var n = [],
            ...
            n[n.length] = c >> 8 & 255, n[n.length] = 255 & c;
          }
          return n;
        ...
        decode.MACSTRING = function(e, n, t, c) {
          var o = eightBitMacEncodings[c];
          if (void 0 !== o) {
            for (var r = "",
                a = 0; a < t; a++) {
              var i = e.getUint8(n + a);
              r += i <= 127 ? String.fromCharCode(i) : o[127 & i];
            }
            return r;
          }
        };
            ...
            getMacEncodingTable = function(e) {
              ...
              if (void 0 !== t) {
                if (macEncodingTableCache) {
                  var c = macEncodingTableCache.get(t);
                  if (void 0 !== c)
                    return c;
                }
                var o = eightBitMacEncodings[e];
                if (void 0 !== o) {
                  for (var r = {},
                      a = 0; a < o.length; a++)
                    r[o.charCodeAt(a)] = a + 128;
        ...
        encode.MACSTRING = function(e, n) {
          ...
          for (n = 0; n < e.length; n += 1) {
            ...
            Array.prototype.push.apply(o, r), t += r.length, c.push(t);
          }
          if (0 === o.length)
            return [0, 0];
          var a = [],
              i = 1 + Math.floor(Math.log(t) / Math.log(2)) / 8 | 0,
              f = [void 0, encode.BYTE, encode.USHORT, encode.UINT24, encode.ULONG][i];
          for (n = 0; n < c.length; n += 1) {
            var d = f(c[n]);
            Array.prototype.push.apply(a, d);
          }
          return Array.prototype.concat(encode.Card16(e.length), encode.OffSize(i), a, o);
          ...
          for (var n = [],
              ...
              c = t.length,
              o = 0; o < c; o += 1) {
            var r = parseInt(t[o], 0),
                a = e[r];
            n = n.concat(encode.OPERAND(a.value, a.type)), n = n.concat(encode.OPERATOR(r));
          }
          return n;
          ...
          if (Array.isArray(n))
            for (var c = 0; c < n.length; c += 1)
              check.argument(e.length === n.length, "Not enough arguments given for type" + n), t = t.concat(encode.OPERAND(e[c], n[c]));
          else if ("SID" === n)
        ...
        encode.CHARSTRING = function(e) {
          ...
          for (n = 0; n < c; n += 1) {
            var a = e.fields[n],
                i = encode[a.type];
            check.argument(void 0 !== i, "No encoding function for field type " + a.type + " (" + a.name + ")");
            var f = e[a.name];
            void 0 === f && (f = a.value);
            var d = i(f);
            "TABLE" === a.type ? (r.push(t.length), t = t.concat([0, 0]), o.push(d)) : t = t.concat(d);
          }
          for (n = 0; n < o.length; n += 1) {
            var u = r[n],
                s = t.length;
            check.argument(s < 65536, "Table " + e.tableName + " too big."), t[u] = s >> 8, t[u + 1] = 255 & s, t = t.concat(o[n]);
          }
          return t;
          ...
          for (var n = 0,
            ...
            var o = e.fields[c],
                r = sizeOf[o.type];
            check.argument(void 0 !== r, "No sizeOf function for field type " + o.type + " (" + o.name + ")");
            var a = e[o.name];
            void 0 === a && (a = o.value), n += r(a), "TABLE" === o.type && (n += 2);
          }
          return n;
      ...
      34: [function(require, module, exports) {
        ...
        exports.isBrowser = function() {
          ...
          for (var e = new Buffer(r.byteLength),
              n = new Uint8Array(r),
              t = 0; t < e.length; ++t)
            e[t] = n[t];
          return e;

...
function parseLookup(lookupType, subTableData) {
  var data = testutil.unhex('00010000 000A 000C 000E' + '0000' + '0000' + '0001 0004' + '000' + lookupType + '0000 0001 0008' + subTableData);
...
describe('tables/gsub.js', function() {
  it('can parse a GSUB header', function() {
    var data = testutil.unhex('00010000 000A 000C 000E' + '0000' + '0000' + '0000');
    assert.deepEqual(gsub.parse(data), {
      version: 1,
      scripts: [],
      features: [],
      lookups: []
  ...
  it('can parse lookup3', function() {
    ...
    assert.deepEqual(parseLookup(3, data), {
      ...
      alternateSets: [[0xc9, 0xca]]
    });
  });
  it('can parse lookup4', function() {
    var data = '0001 000A 0002 0014 0020' + '0002 0001 0019 001A 0000' + '0001 0004 015B 0003 0028 0017' + '0002 0006 000E 00F1 0003 001A 001D 00F0 0002 001D';
    assert.deepEqual(parseLookup(4, data), {
      ...
      ligatureSets: [[{
        ligGlyph: 0x15B,
        components: [0x28, 0x17]
      }], [{
        ligGlyph: 0xf1,
        components: [0x1a, 0x1d]
      }, {
        ligGlyph: 0xf0,
        components: [0x1d]
      }]]
  ...
  it('can parse lookup5 substFormat 1', function() {
    var data = '0001 000A 0002 0012 0020' + '0001 0002 0028 005D' + '0001 0004 0002 0001 005D 0000 0001' + '0001 0004 0002 0001 0028 0001 0001';
  ...
  it('can parse lookup5 substFormat 2', function() {
    var data = '0002 0010 001C 0004 0000 0000 0032 0040' + '0001 0004 0030 0031 0040 0041' + '0002 0003 0030 0031 0002 0040 0041 0003 00D2 00D3 0001' + '0001 0004 0002 0001 0001 0001 0001' + '0001 0004 0002 0001 0001 0001 0002';
    assert.deepEqual(parseLookup(5, data), {
      substFormat: 2,
      coverage: {
        format: 1,
  ...
  it('can parse lookup5 substFormat 3', function() {
    var data = '0003 0003 0002 0014 0030 0052 0000 0001 0002 0002' + '0001 000C 0033 0035 0037 0038 0039 003B 003C 003D 0041 0042 0045 004A' + '0001 000F 0032 0034 0036 003A 003E 003F 0040 0043 0044 0045 0046 0047 0048 0049 004B' + '0001 0005 0038 003B 0041 0042 004A';
    assert.deepEqual(parseLookup(5, data), {
      substFormat: 3,
      coverages: [{
        format: 1,
  ...
  it('can parse lookup8', function() {
    var data = '0001 0068 0001 0000 0001 0026 000C 00A7 00B9 00C5 00D4 00EA 00F2 00FD 010D 011B 012B 013B 0141' + '0001 001F 00A5 00A9 00AA 00E2 0167 0168 0169 016D 016E 0170 0183' + '0184 0185 0189 018A 018C019F 01A0 01A1 01A2 01A3 01A4 01A5 01A6' + '01A7 01A8 01A9 01AA 01AB 01AC 01EC' + '0001 000C 00A6 00B7 00C3 00D2 00E9 00F1 00FC 010C 0119 0129 013A 0140';
    ...
    assert.deepEqual(parsed, {
      ...
      lookaheadCoverage: [{
        format: 1,
        glyphs: [0xa5, 0xa9, 0xaa, 0xe2, 0x167, 0x168, 0x169, 0x16d, 0x16e, 0x170, 0x183, 0x184, 0x185, 0x189, 0x18a, 0x18c, 0x19f, 0x1a0, 0x1a1, 0x1a2, 0x1a3, 0x1a4, 0x1a5, 0x1a6, 0x1a7, 0x1a8, 0x1a9, 0x1aa, 0x1ab, 0x1ac, 0x1ec]
      }],
  ...
  it('should write a simple GSUB table + lookup type 4', function() {
    var expectedData = testutil.unhexArray('00 01 00 00 00 0A 00 1E  00 2C 00 01 44 46 4C 54  00 08 00 04 00 00 00 00  FF FF 00 01 00 00 00 01' + '6C 69 67 61 00 08 00 00  00 01 00 00 00 01 00 04  00 04 00 00 00 01 00 08  00 01 00 0A 00 02 00 12' + '00 2E 00 01 00 02 00 18  00 1A 00 03 00 08 00 10  00 16 04 8A 00 03 00 34  00 34 04 84 00 02 00 18' + '04 83 00 02 00 34 00 01  00 04 04 8D 00 02 00 1D');
    var gsubTable = {
      version: 1,
      scripts: [{
        tag: 'DFLT',
